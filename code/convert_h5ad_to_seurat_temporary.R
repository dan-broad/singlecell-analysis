#author: "Bo Li, edits by Yuuna Klindziuk (to avoid errors in transitional phase of script)"
#date: "7/30/21"

### This script is modified from conversion.R of Seurat V2 source code. 
### Seurat is licensed under GPL 3.0
